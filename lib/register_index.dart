...
import 'package:flutter/material.dart';
import 'package:kos_dea/register_pemilik_kos.dart';
import 'package:kos_dea/register_pencari_kos.dart';
              ...
              Padding(
                  ...
                  child: Column(
                      ...
                      [
                        ...
                        Text('Saya ingin daftar sebagai',
                        ...
                        OutlinedButton(
                          onPressed: () {
                            Route route = MaterialPageRoute(
                                builder: (context) => RegisterPemilikKos());
                        ...
                        OutlinedButton(
                          ...
                          onPressed: () {
                            Route route = MaterialPageRoute(
                                builder: (context) => RegisterPencariKos());
                            Navigator.push(context, route);
                          },
